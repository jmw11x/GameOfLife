...
//the function builds shapefirst and select cells before calling play
//the i in play will keep it going
//need to pass an argument that updates i for how long it can go
function play(){
    var block= document.getElementById("block");
    if(block.checked){return;}
	if (playOnce){
    //document.getElementById("timerButton").innerHTML = "Generations: " + counter;
    document.getElementById("timerButton").innerHTML = "Generations: " + counter;
    localStorage.generationcount = counter;
    counter = counter + 1;
