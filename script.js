...
function genGrid(){
    ...
    var rows = 50;//Math.floor(Math.random() * (71 - 51 + 1) + 51);;
    var cols = 50;//Math.floor(Math.random() * (71 - 51 + 1) + 51);;
...
function setShape(){
    ...
    if(block.checked){
        ...
        document.getElementById("25,25").style.backgroundColor = "#FF5F1F";
        map["25,26"] = 1;
        document.getElementById("25,26").style.backgroundColor = "#FF5F1F";
        map["24,26"] = 1;
        document.getElementById("24,26").style.backgroundColor = "#FF5F1F";
        map["23,25"] = 1;
        document.getElementById("23,25").style.backgroundColor = "#FF5F1F";

        map["24,24"] = 0;
        document.getElementById("24,24").style.backgroundColor = "black";
        map["24,25"] = 0;
        document.getElementById("24,25").style.backgroundColor = "black";
        map["24,23"] = 0;
        document.getElementById("24,23").style.backgroundColor = "black";
        map["25,27"] = 0;
        document.getElementById("25,27").style.backgroundColor = "black";
        map["26,27"] = 0;
